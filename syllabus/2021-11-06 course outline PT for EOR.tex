...
%	\node[punktchain, join, ] (emperi) {Emperi};
	\node (asym) [punktchain ]  {(I.2) \textbf{On-campus tutorials} (earn a bonus of at most 0.5/10)};
	...
	\begin{scope}[start branch=hoejre,]
		\node (finans) [punktchain, on chain=going right] {(II) \textbf{Two group assignments with dealines in weeks 3 and 6.} (20\%)};
	\end{scope}
	\node[punktchain, join,] (disk) {Come to office 5411.0771 during the office hour (every Wednesday 4 pm-5 pm) if there are additional questions. Send one email to l.kong@rug.nl for an appointment in advance.};
	\node[punktchain, join,] (makro) {III. \textbf{Final Exam/resit} (80\%) + exam/resit inspections};
